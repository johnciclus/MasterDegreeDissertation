...
\end{lstlisting}
\inputencoding{utf8}
\caption{Código de novo indicador}
...
\caption{Adição de feature na DSL}
\end{algorithm}
\item Dar click na opção “Save” - Procurar o indicador cadastrado na interface
...
\includepdf[pages=-,width=1\paperwidth]{/home/john/Desktop/Dissertation/pages/workshop}
