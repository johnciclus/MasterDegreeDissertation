...
\begin{figure}[H]
\centering{}\includegraphics[width=0.8\columnwidth]{\string"figures/Decisioner Architecture\string".eps}\caption{Arquitetura do Decisioner\label{fig:Interfaces}}
\end{figure}
...
\begin{figure}
\begin{centering}
\includegraphics[width=0.8\columnwidth]{\string"figures/Decisioner Methodology\string".eps}
\par\end{centering}
...
relacionadas. A Listagem \ref{lis:DSL-para-defini=0000E7=0000E3o}
...
\inputencoding{latin9}\begin{lstlisting}[caption={Defini��o do Evaluation Object  },label={lis:DSL-para-defini=0000E7=0000E3o}]
...
\par\end{centering}
\caption{Widgets geradas a partir da definição da DSL\label{fig:Widgets-geradas-da-DSL}}
\end{figure}
...
serão apresentados (Listagem \ref{lis:Defini=0000E7=0000E3o-da-logica}).
...
podem gerar múltiplos resultados de avaliação. Na Listagem \ref{lis:Defini=0000E7=0000E3o-da-logica},
...
\inputencoding{latin9}\begin{lstlisting}[caption={Defini��o da l�gica de avalia��o.},label={lis:Defini=0000E7=0000E3o-da-logica}]
report {     
...
a representação e compreensão dos resultados da avaliação. Na listagem
\ref{lis:Defini=0000E7=0000E3o-das-widgets} o comando \textit{sustainabilityMatrix
...
\inputencoding{latin9}\begin{lstlisting}[caption={Defini��o dos componentes visuais do relat�rio. },label={lis:Defini=0000E7=0000E3o-das-widgets}]
report {
 ...
...
\end{lstlisting}
\inputencoding{utf8} Por meio dos comandos da DSL, é possível definir o comportamento
e as características gerais dos SAD. 
...
\begin{figure}[H]
\begin{centering}
\includegraphics[width=0.6\columnwidth]{\string"figures/Decisioner Core Architecture\string".eps}
\par\end{centering}
...
Decisioner. O que permitirá generalizar ainda mais o framework e servir
como um caso de uso adicional para validar as hipóteses em outros
domínios.

Esta arquitetura foi avaliada por meio da instanciação do SAD SustenAgro,
o que permite validar se realmente funcionam cada uma das características
aqui descritas. No capítulo seguinte será apresentado o SAD SustenAgro,
gerado como primeiro caso de uso deste Framework, e depois será apresentado
o processo de avaliação que formaliza a avaliação deste sistema.
