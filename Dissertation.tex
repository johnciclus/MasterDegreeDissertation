...
\listof{algorithm}{Lista de Algoritmos}
...
\label{chap:Sustainability_Assessment}\input{chapters/Sustainability_assessment.tex}

\chapter{Indicadores de Sustentabilidade}

\label{chap:SustainabilityIndicators}\input{chapters/Sustainability_indicators.tex}

\chapter{Instalação}

\label{chap:Instalation}\input{chapters/Instalation.tex}
